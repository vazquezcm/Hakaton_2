...
public class Main {
    public static void main(String[] args) {
        ...
        Agenda a = null;
            ...
            int opc;
        do {
        System.out.println("Bienvenido al sistema! Qué desea hacer? 1.- Añadir contacto 2.-Listar contacto 4.- Eliminar contacto 5.-Verificar agenda llena 6.-Espacios libres 0.-Salir");
         opc = scan.nextInt();
            scan.nextLine();
        switch(opc) {
            case 1:
